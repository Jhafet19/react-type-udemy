...
import DropTask from "@/components/tasks/DropTask.tsx";
import {DndContext, DragEndEvent} from "@dnd-kit/core";
import {useMutation, useQueryClient} from "@tanstack/react-query";
import {updateStatus} from "@/api/TaskAPI.ts";
...
const initalStatusGroups: GroupedTasks = {
    pending: [],
    inProgress: [],
    onHold: [],
    underReview: [],
...
export default function TaskList({tasks, canEdit}: TaskListProps) {
    ...
    const handleDragEnd = (e: DragEndEvent) => {
        console.log("🚀 ~ handleDrangEnd ~ e: ", e);
        const {over, active} = e
        if (over && over.id) {
