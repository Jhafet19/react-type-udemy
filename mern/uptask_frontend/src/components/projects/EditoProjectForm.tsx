import { Project, ProjectFormaData } from "@/types/index";
...
type EditoProjectFormProps = {
    data: ProjectFormaData,
    projectId: Project['_id']
}

export default function EditoProjectForm({ data, projectId }: EditoProjectFormProps) {

    const initialValues: ProjectFormaData = {
    ...
    const handleForm = (formData: ProjectFormaData) => {
