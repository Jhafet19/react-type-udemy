...
export default function DashboardView() {
    ...
    if (data) return (
        <>
            ...
            <p className="text-2xl font-light text-gray-500 mt-5">Maneja y adminsitra tus proyectos</p>
                                ...
                                <div className="min-w-0 flex-auto space-y-2">
                                    <div className='mt-2'>
                                        ...
                                        border-indigo-500 rounded-lg inline-block py-1 px-5'> Manager</p> :
                                            <p className='font-bold text-xs uppercase bg-green-50
                                            text-green-500 border-2border-green-500 rounded-lg inline-block py-1 px-5
                                            '> Colaborador</p>
                                        }
                                    </div>
