...
import {getProjectTeam, removeUserFromProject} from "@/api/TeamAPI.ts";
...
function ProjectTeamView() {
    ...
    if (data) return (
        <>
        <h1 className="text-5xl font-black ">Administrar Equiop</h1>
...
:
    ...
    ;
    console.log("🚀 ~ ProjectTeamView ~ member: ", member);
}
